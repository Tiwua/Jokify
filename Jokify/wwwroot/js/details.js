    ...
    $(".edit-button").on("click", function () {
        ...
        if (target.classList.contains('edit-button') || target.classList.contains('delete-button')) {
            ...
            function updateSaveButtonState() {
                const editContentTextarea = document.querySelector(".comment-content").value;
                const text = commentElement.querySelector(".text").textContent;

                const hasChanges = editContentTextarea !== text;
            ...
            commentElement.addEventListener('input', updateSaveButtonState);
        }
